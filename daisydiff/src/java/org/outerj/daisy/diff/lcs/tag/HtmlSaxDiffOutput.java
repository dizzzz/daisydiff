 ...
 * This version is used for tag based diff results.
 */
public class HtmlSaxDiffOutput {
    
    private ContentHandler consumer;

    public HtmlSaxDiffOutput(ContentHandler consumer) throws SAXException {
        ...
        for (int i = 0; i < c.length; i++) {
            ...
            case '<':
                if (insideTag == false) {
                    ...
                    throw new IllegalArgumentException(
                            "This is not well formed HTML: There's a tag inside a tag.");
            ...
            case '>':
                ...
                if (insideTag == true) {
                    ...
                    throw new IllegalArgumentException(
                            "This is not well formed HTML: A tag is closed without being opened.");
                break;
            default:
