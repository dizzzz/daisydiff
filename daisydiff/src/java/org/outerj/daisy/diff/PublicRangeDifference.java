 ...
 */
public class PublicRangeDifference {
	 ...
	 */
	public PublicRangeDifference(int changeKind) {
		fKind= changeKind;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof PublicRangeDifference) {
			PublicRangeDifference other = (PublicRangeDifference) obj;
